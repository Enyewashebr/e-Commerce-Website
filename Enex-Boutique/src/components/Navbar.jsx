  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium ">
      ...
      <ul className="hidden sm:flex gap-5 text-sm text-gray-700 ">
        <NavLink
          to="/"
          className="flex flex-col items-center gap-1   hover:bg-[#93eff2] "
        >
          <p>HOME</p>
          <hr className="w-12 border-none h-[1.5px] bg-[#15a3a8]  hidden " />
        </NavLink>
        <NavLink
          to="/collection"
          className="flex flex-col items-center gap-1  hover:bg-[#93eff2]"
        >
          <p>COLLECTION</p>
          <hr className="w-20  border-none h-[1.5px] bg-[#15a3a8]  hidden" />
        </NavLink>
        <NavLink
          to="/about"
          className="flex flex-col items-center gap-1  hover:bg-[#93eff2]"
